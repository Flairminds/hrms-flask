...
import { APIURLFlask } from '../../services/api';
...
export const SkillEvaluation = ({ employee, onClose }) => {
    ...
    const fetchSkillsList = async () => {
      try {
        const response = await axios.get(`${APIURLFlask}/skills/employee`);
    ...
    const loadEmployeeSkills = async (employeeId) => {
      try {
        const response = await axios.get(`${APIURLFlask}/skill-statuses/${employeeId}`);
    ...
    //     };
    //     const response = await axios.post(`${APIURLFlask}/save-review`, payload);
    ...
    const handleAddNewSkill = async (newSkillData) => {
      try {
        ...
        const skillResponse = await axios.post(`${APIURLFlask}/add-employee-skill`, skillPayload);
        ...
        const reviewResponse = await axios.post(`${APIURLFlask}/save-review`, reviewPayload);
