...
def create_app(config_name):
    ...
    from .routes.timelog import timelog_bp
    ...
    from .routes.capability_development.capability_group import capability_group_bp
    ...
    app.register_blueprint(timelog_bp, url_prefix='/api/timelog')
    ...
    app.register_blueprint(capability_group_bp, url_prefix='/api/capability-dev/capability-groups')
