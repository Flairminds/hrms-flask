...
@roles_required(*ROLE_PERMISSIONS["documents"]["employee_details_for_relieving"])
...
@roles_required(*ROLE_PERMISSIONS["documents"]["hr_relieving_letters"])
...
@roles_required(*ROLE_PERMISSIONS["documents"]["get_relieving_letters"])
...
@roles_required(*ROLE_PERMISSIONS["documents"]["create_relieving_letter"])
...
@roles_required(*ROLE_PERMISSIONS["documents"]["send_relieving_letter_email"])
...
@roles_required(*ROLE_PERMISSIONS["documents"]["update_relieving_letter"])
...
@roles_required(*ROLE_PERMISSIONS["documents"]["download_relieving_letter"])
...
@roles_required(*ROLE_PERMISSIONS["documents"]["get_document"])
...
@roles_required(*ROLE_PERMISSIONS["documents"]["delete_document"])
def delete_document():
    return DocumentController.delete_document()


@documents_bp.route("/document-status/<emp_id>", methods=["GET"])
@roles_required(*ROLE_PERMISSIONS["documents"]["document_status"])
...
@roles_required(*ROLE_PERMISSIONS["documents"]["verify_document"])
def verify_document():
    return DocumentController.verify_document()


@documents_bp.route("/document-verification-status/<emp_id>", methods=["GET"])
@roles_required(*ROLE_PERMISSIONS["documents"]["document_verification_status"])
...
@roles_required(*ROLE_PERMISSIONS["documents"]["document_status_details"])
...
@roles_required(*ROLE_PERMISSIONS["documents"]["incomplete_employees"])
def incomplete_employees():
    return DocumentController.incomplete_employees()

@documents_bp.route("/all-employees-docs", methods=["GET"])
@roles_required(*ROLE_PERMISSIONS["documents"]["all_employees_docs_status"])
