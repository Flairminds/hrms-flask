...
@roles_required(*ROLE_PERMISSIONS["skills"]["employee_skills"])
...
@roles_required(*ROLE_PERMISSIONS["skills"]["add_update_skills"])
...
@roles_required(*ROLE_PERMISSIONS["skills"]["get_employee_skills"])
...
@roles_required(*ROLE_PERMISSIONS["skills"]["employees_with_skills"])
