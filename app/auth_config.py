...
ROLE_PERMISSIONS = {
    ...
    # ===========================
    "hr": {
        "get_all_employees": ["Admin", "HR", "Lead", "Employee"],
    ...
    "documents": {
        ...
        "upload_document": ["Admin", "HR", "Lead", "Employee"],
        "get_document": ["Admin", "HR", "Lead", "Employee"],
        "delete_document": ["Admin", "HR", "Lead", "Employee"],
        "document_status": ["Admin", "HR", "Lead", "Employee"],
        "verify_document": ["Admin", "HR"],
        "document_verification_status": ["Admin", "HR", "Lead", "Employee"],
        "document_status_details": ["Admin", "HR", "Lead", "Employee"],
