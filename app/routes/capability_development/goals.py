...
capability_dev_goals_new_bp = Blueprint("capability_dev_goals_new", __name__)
...
@capability_dev_goals_new_bp.route("/<int:goal_id>", methods=["PUT"])
def update_goal(goal_id):
    """Update goal details."""
    return GoalsController.update_goal(goal_id)


@capability_dev_goals_new_bp.route("/<int:goal_id>", methods=["DELETE"])
def delete_goal(goal_id):
    """Delete a goal."""
    return GoalsController.delete_goal(goal_id)


@capability_dev_goals_new_bp.route("/<int:goal_id>/progress", methods=["PUT"])
...
@capability_dev_goals_new_bp.route("/<int:goal_id>/comments", methods=["GET"])
def get_goal_comments(goal_id):
    """Get all comments for a goal."""
    return GoalsController.get_goal_comments(goal_id)


@capability_dev_goals_new_bp.route("/<int:goal_id>/comments", methods=["POST"])
...
@capability_dev_goals_new_bp.route("/<int:goal_id>/reviews", methods=["GET"])
def get_goal_reviews(goal_id):
    """Get all reviews for a goal."""
    return GoalsController.get_goal_reviews(goal_id)


@capability_dev_goals_new_bp.route("/<int:goal_id>/reviews", methods=["POST"])
